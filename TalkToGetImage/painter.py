...
import PIL.Image # pro vision needs
import os
...
def generate_image_with_dalle(prompt):
    ...
    # save created image to local folder by dynamic address
...
# Text + Image -> Image (Gemini Vision Pro) - MultiModal
...
def generate_image(image_path, prompt):
    ...
    return filename # saved imagefile address 